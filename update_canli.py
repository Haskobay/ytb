...
def get_videos(channel_id, event_type="live"):
...
def main():
    ...
    for cid in channels:
        media_items += get_videos(cid.strip(), event_type="live")      # Şu an yayınlanan
        media_items += get_videos(cid.strip(), event_type="upcoming")  # Yakında başlayacak
